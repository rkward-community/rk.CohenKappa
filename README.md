...
```
devtools::install_github("rkward-community/rk.CohenKappa") # stable release
devtools::install_github("rkward-community/rk.CohenKappa", ref="develop") # development release
```
